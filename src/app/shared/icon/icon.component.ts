...
/**
 * Lightweight inline-SVG icon set (subset of Lucide icons, hand-picked
 * for this portfolio) so the project has zero icon-library dependency.
 */
